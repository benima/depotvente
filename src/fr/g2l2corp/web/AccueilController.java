...
import fr.g2l2corp.model.Fournisseur;
 ...
 */
@WebServlet("/depotvente/*")
public class AccueilController extends HttpServlet {
	private static final long serialVersionUID = 1L;
	@PersistenceContext
	private EntityManager em;
       private ProduitDAOJPA produitdao=new ProduitDAOJPA();
       private FournisseurDAOJPA fournisseurdao= new FournisseurDAOJPA();
    /**
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (action!=null && action.equals("enregistrerproduit")) {
			...
			System.out.println(oproduit);
			try {
				produitdao.create(oproduit);
			} catch (Exception e) {
